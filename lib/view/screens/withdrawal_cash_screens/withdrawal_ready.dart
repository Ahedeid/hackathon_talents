...
class WithdrawalCashReady extends StatelessWidget {
  const WithdrawalCashReady({super.key});
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: const Text(
                            "Ready",
                            style:
                                TextStyle(color: Color(AppColor.primaryButtonColor),fontWeight: FontWeight.w700),
                          ),
                        )
                      ],
                    ),

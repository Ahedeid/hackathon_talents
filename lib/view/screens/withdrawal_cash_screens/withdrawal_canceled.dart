...
class WithdrawalCanceledCash extends StatelessWidget {
  const WithdrawalCanceledCash({super.key});
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: const Text(
                            "Canceled",
                            style:
                                TextStyle(color: Color(AppColor.borderColorUnSelected),fontWeight: FontWeight.w700),
                          ),
                        )
                      ],
                    ),
                  ...
                  children: [
                    ...
                    Row(
                      children: const [
                        Text("Office Name",
                            style: TextStyle(
                                fontSize: 13, color: Color(AppColor.grey))),
                        Spacer(),
